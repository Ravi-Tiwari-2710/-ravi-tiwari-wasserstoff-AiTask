...
const botConfigData = {
    botStatus: 1,
    botImageURL: 'https://learnwithhasan.com/wp-content/uploads/2023/09/pngtree-businessman-user-avatar-wearing-suit-with-red-tie-png-image_5809521.png',
    userAvatarURL: 'https://learnwithhasan.com/wp-content/uploads/2023/12/site-logo-mobile.png',
    fontSize: 14,
    StartUpMessage: 'Hello! How can I assist you today?',
    commonButtons: [
        {
            buttonText: 'Option 1',
            buttonPrompt: 'Prompt for option 1'
        },
        {
            buttonText: 'Option 2',
            buttonPrompt: 'Prompt for option 2'
        },
...
async function lwhOpenCbotfetchData() {
    ...
    try {
        const response = await fetch(`${window.location.origin}/wp-json/myapi/v1/chat-bot/`, {
            method: 'POST',
            headers: {
...
// Initialize bot with hardcoded configuration
